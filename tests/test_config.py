...
from autofeedsync.cli import _prompt_for_save_path, resolve_save_path
from autofeedsync.config import get_config_path, get_system_downloads_path, load_config
...
class ConfigTests(unittest.TestCase):
    ...
    def test_resolve_save_path_falls_back_to_downloads_without_prompt(self) -> None:
        ...
        with patch("autofeedsync.cli.get_system_downloads_path", return_value="D:\\Downloads"):
            resolved = resolve_save_path(
                None,
                AppConfig(),
                prompt_for_default=False,
    ...
    def test_resolve_save_path_uses_interactive_prompt_result(self) -> None:
        ...
        with patch("autofeedsync.cli._prompt_for_save_path", return_value="D:\\Anime\\Library"):
            resolved = resolve_save_path(
                None,
                AppConfig(),
    ...
    def test_prompt_for_save_path_can_save_selected_downloads_as_default(self) -> None:
        ...
        with patch("autofeedsync.cli.select_option", return_value="downloads"), patch(
    ...
    def test_prompt_for_save_path_can_browse_without_saving_default(self) -> None:
        ...
        with patch("autofeedsync.cli.select_option", return_value="browse"), patch(
            "autofeedsync.cli.get_system_downloads_path", return_value="D:\\Downloads"
        ), patch("autofeedsync.cli.pick_directory", return_value="D:\\Anime\\Picked"), patch(
            "autofeedsync.cli.confirm_choice", return_value=False
        ):
            resolved = _prompt_for_save_path(
                AppConfig(),
                config_path=config_path,
    ...
    def test_prompt_for_save_path_uses_saved_default_selection(self) -> None:
        ...
        with patch("autofeedsync.cli.select_option", return_value="saved-default"):
            resolved = _prompt_for_save_path(
                AppConfig(default_save_path="D:\\Anime\\Default"),
                config_path=config_path,
            )
